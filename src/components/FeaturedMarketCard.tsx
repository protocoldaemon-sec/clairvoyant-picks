        ...
        <div className="max-w-2xl mx-auto">
          <div className="p-6 lg:p-8 rounded-2xl border border-border bg-card shadow-card">
            <div className="flex items-start justify-between mb-4">
              <Badge className="bg-accent/10 text-accent hover:bg-accent/10 border-0">
            ...
            <div className="grid grid-cols-3 gap-3 mb-6">
              ...
              <div className="p-4 rounded-xl bg-accent/20 text-center">
                ...
                <div className="text-2xl font-bold text-accent">+203%</div>
              </div>
            </div>
            ...
            <Button className="w-full gap-2 bg-accent text-accent-foreground hover:bg-accent/90 h-12">
              Lihat Semua Peluang
