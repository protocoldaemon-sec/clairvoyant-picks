    ...
    <section id="pricing" className="py-12 lg:py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          <div className="p-8 rounded-2xl border-2 border-success/30 bg-accent text-center">
            <div className="text-xs font-medium text-success uppercase tracking-wide mb-4">
              Saat Anda Menang
            </div>
            ...
            <div className="p-4 rounded-xl bg-card text-sm text-muted-foreground">
